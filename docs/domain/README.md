...
- widok kolejkowy `shipment-readiness` pozwala pobrać zbiorczo urządzenia gotowe i zablokowane do wysyłki, a także ich agregację per `blocking_code`, co upraszcza budowę dashboardu operacyjnego
