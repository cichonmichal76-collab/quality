...
- widok kolejkowy `component-quality` pozwala zebrać te same dane dla wielu urządzeń i agregować komponenty per `quality_status`, co pomaga jakości i produkcji szybciej rozbić problemy na `QC_NOT_PASSED` oraz `CRITICAL_NCR_OPEN`
