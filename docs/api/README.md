...
```bash
curl "http://localhost:8000/api/shipment-readiness?device_type=ZSS&only_blocked=true&primary_blocking_code=CRITICAL_OPEN_NCR&recommended_action=RESOLVE_CRITICAL_NCR&sort_by=priority&limit=50"
```
