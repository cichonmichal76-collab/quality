...
class QcStep(Base):
    ...
    region_x: Mapped[float | None] = mapped_column(Numeric, nullable=True)
    region_y: Mapped[float | None] = mapped_column(Numeric, nullable=True)
    region_width: Mapped[float | None] = mapped_column(Numeric, nullable=True)
    region_height: Mapped[float | None] = mapped_column(Numeric, nullable=True)
...
class ProductionItem(Base):
    ...
    qc_reserved_by_operator_id: Mapped[str | None] = mapped_column(String, nullable=True)
    qc_reserved_by_workstation_id: Mapped[str | None] = mapped_column(String, nullable=True)
    qc_reserved_at: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
